...
public class s313 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
  public DownloadResponse getReport() throws Exception {
       ...
       try {
        ...
        /*  parameters.put("codpersona", idp);
          ...
          URL fileUrl = this.getClass().getResource("313.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("313.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("Detalles Grupo_familiar Matriculados y Activos.pdf");
