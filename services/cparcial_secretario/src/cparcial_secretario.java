...
public class cparcial_secretario extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
     ...
     System.out.println("Año "+idy);
      ...
      Long dtnum2=Long.valueOf(fecha2);
       ...
       try {
          ...
          URL fileUrl = this.getClass().getResource("Certificado_FECHA_secretario.jasper");
          ...
          ret.setFileName("Certificado_Parcial(Secretario).pdf");
