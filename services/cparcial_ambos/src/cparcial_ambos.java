...
public class cparcial_ambos extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
   public DownloadResponse getReport(String idp, String idy, String fecha1, String fecha2) throws Exception {
      ...
      Long dtnum2=Long.valueOf(fecha2);
       ...
       try {
          ...
          URL fileUrl = this.getClass().getResource("Certificado_FECHA_ambos.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("Certificado_FECHA_ambos.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("Certificado_Parcial(Ambos).pdf");
